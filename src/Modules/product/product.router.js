...
router.get('/showcolor_size_qutupdate/:productId', auth([roles.stakeHolder,roles.Admin,roles.Customer]), asyncHandler(productController.showcolor_size_qutupdate));
